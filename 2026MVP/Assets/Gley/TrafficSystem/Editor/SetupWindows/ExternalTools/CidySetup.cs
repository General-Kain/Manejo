...
namespace Gley.TrafficSystem.Editor
{
    public class CidySetup : SetupWindowBase
    {
        ...
        {
            base.TopPart();
            EditorGUILayout.LabelField("Temporary not available due to internal errors. It should be reintroduced in the next releases. Use v3.3.7 for now if you need CiDy support");

            ...
            for (int i = 0; i < allIntersections.Length; i++)
            {
                switch (allIntersections[i].Type)
                {
                    case IntersectionType.Priority:
                        ...
                        {
                            priorityInersection.AddPedestrianWaypoints(j, bridge.GetWaypointIndices(priorityIntersectionEditor.enterWaypoints[j].pedestrianWaypoints), bridge.GetWaypointIndices(priorityIntersectionEditor.enterWaypoints[j].directionWaypoints));
                        }
                        break;
                    case IntersectionType.PriorityCrossing:
                        ...
                        {
                            priorityCrossing.AddPedestrianWaypoints(j, bridge.GetWaypointIndices(priorityCrossingEditor.enterWaypoints[j].pedestrianWaypoints),bridge.GetWaypointIndices(priorityCrossingEditor.enterWaypoints[j].directionWaypoints));
                        }
                        break;
                    ...
                    case IntersectionType.LightsCrossing:
                        ...
                        trafficLightsCrossing.AddPedestrianWaypoints(bridge.GetWaypointIndices(trafficLightsCrossingEditor.pedestrianWaypoints),bridge.GetWaypointIndices( trafficLightsCrossingEditor.directionWaypoints), trafficLightsCrossingEditor.pedestrianRedLightObjects.ToArray(), trafficLightsCrossingEditor.pedestrianGreenLightObjects.ToArray());
                        break;
                }
            }
#endif

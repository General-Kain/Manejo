...
public class RCCP_Engine : RCCP_Component {
    ...
    /// </summary>
    [Min(0f), Tooltip("Torque multiplier from turbo at max boost.")]
    ...
    /// </summary>
    [Range(.01f, .5f), Tooltip("Engine inertia. Lower values = faster RPM changes.")]
    ...
    [Tooltip("Target maximum speed in km/h. Used to auto-calculate differential ratio.")]

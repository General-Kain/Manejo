...
public class RCCP_Stability : RCCP_Component {
    ...
    private void Drift() {
        ...
        // Prevents force application during wheel lift-off
        ...
        // Calculate actual grounded ratio for force scaling
        ...
        //    - Scaled by 2000f * Abs(sidewaysSlip^2)
        //    - Also scaled by clamp01( Abs(forwardSlip^2 * 4f) ),
        //      meaning the forward slip must be significant for max effect.
        //    - 'CarController.direction' flips this force if in reverse.

        // Calculate target forward drift force
        ...
        // Smooth the forward force transition
        ...
        //    - Scaled by 1500f * pRearWheelSlipAmountSideways
        //    - Also scaled by clamp01(Abs( clamp(forwardSlip, 0f, 1f) * 4f ))
        //      -> ensures some forward slip is needed
        //    - 'CarController.direction' flips if reverse.

        // Calculate target sideways drift force
        ...
        // Smooth the sideways force transition
